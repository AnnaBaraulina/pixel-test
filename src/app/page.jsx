    ...
    <main className="container flex flex-col justify-center items-center">
      <div className="flex justify-center items-center mb-20 md:flex-wrap">
        <div className="flex flex-col justify-start mr-6 md:mt-14">
          <h1 className="text-gray-98 font-mono font-normal leading-none mb-6 text-[76px] sm:text-[56px] xs:text-[32px]">
      ...
      <div className="flex justify-around items-center w-[90%] lg:!justify-between lg:!w-[100%] md:flex-wrap md:gap-10 md:!justify-center xs:!justify-start">
        <div className="flex flex-col justify-start items-start">
          <Image src="/images/3x.png" alt="Three times faster icon" width={134} height={126} />
        ...
        <div className="flex flex-col justify-start items-start">
          <Image src="/images/10.png" alt="Ten percent icon" width={279} height={136} />
        ...
        <div className="flex flex-col justify-start items-start">
          <Image src="/images/30.png" alt="Three times faster icon" width={156} height={136} />
